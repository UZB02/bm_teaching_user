...
import RandomQuizForm from '../../components/OptionQuizs/OptionQuizsForm.vue'
import RandomQuizCards from '../../components/OptionQuizs/RandomOptionsQuizCard.vue'
...
const fetchRandomQuestions = async () => {
  try {
    const res = await axios.get('/optionquizs/random', {
    ...
    console.log('Random options savollar:', randomQuizs.value)
  } catch (err) {
